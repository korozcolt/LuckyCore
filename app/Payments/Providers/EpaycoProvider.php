...
/**
 * ePayco Payment Provider (Stub - To be implemented in Sprint 5).
 *
 * @see https://docs.epayco.co/
 */
class EpaycoProvider extends AbstractPaymentProvider
{
    ...
    {
        throw PaymentProviderException::notImplemented(PaymentProvider::Epayco);
    }
